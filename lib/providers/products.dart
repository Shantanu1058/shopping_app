...
class Products with ChangeNotifier {
  ...
  Future<void> updateProduct(String id, Product newProduct) async {
    ...
    if (prodIndex >= 0) {
      final url =
          'https://flutter-update-8c759.firebaseio.com/$id.json?auth=$authToken';
  ...
  Future<void> getProducts([bool filterByUser = false]) async {
    ...
    var url =
        'https://flutter-update-8c759.firebaseio.com/products.json?auth=$authToken&$filter';
    try {
      ...
      url =
          'https://flutter-update-8c759.firebaseio.com/userFavroites/$userId.json?auth=$authToken';
  ...
  Future<void> addProduct(Product product) async {
    final url =
        'https://flutter-update-8c759.firebaseio.com/products.json?auth=$authToken';
    try {
